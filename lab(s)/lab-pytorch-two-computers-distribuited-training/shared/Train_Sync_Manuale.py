...
# In questo caso l'aggiornamento dei gradienti avviene in locale ad ogni step senza scambi di rete.
...
# Fa fare 5 giri di studio sincronizzando i pesi con All-Reduce solo a fine epoca, poi fa fare verifica e salvataggio solo a pc1.
def demo_basic(rank, world_size):
    ...
    for t in range(epochs):
        ...
        # parte aggiunta: sincronizzazione manuale dei pesi (All-Reduce) a fine epoca ---
